...
ELASTICSEARCH_BULK_MAX_BYTES = 10 * 1024 * 1024  # 10MB HTTP payload limit
ELASTICSEARCH_STREAM_BATCH_SIZE = 1_000
ELASTICSEARCH_INDEX_SCHEMA_VERSION: str = "text-index-schema@1.2.0"
